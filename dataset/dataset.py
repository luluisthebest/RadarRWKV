...
class RADIal(Dataset):
    ...
    def __init__(self, root_dir,statistics=None,encoder=None,difficult=False,perform_FFT='ADC'):
    ...
    def __getitem__(self, index):
        ...
        if self.perform_FFT == 'ADC':
            radar_name = os.path.join(self.root_dir, 'Generate_ADC', "adc_{:06d}.npy".format(sample_id))
